...
# This module defines the show_graph() function to visualize a TensorFlow graph within Jupyter.abs
...
def show_computational_graph(graph_def, max_const_size=32):
