...
def make_dataset(dataset, n_labeled, n_unlabeled):
    ...
    return trainX, trainY, testX, testY, prior


def load_dataset(dataset_name, n_labeled, n_unlabeled, data_home="."):
    if dataset_name == "mnist":
        (trainX, trainY), (testX, testY) = get_mnist(data_home=data_home)
    ...
    trainX, trainY, testX, testY, prior = make_dataset(((trainX, trainY), (testX, testY)), n_labeled, n_unlabeled)
    return trainX, trainY, testX, testY, prior
